...
bool colorMap(int region)
{
    ...
    {
			colors[region] = color;
      if (colorMap(region + 1)) return true;
...
int main(void)
{
  ...
  map[0] = neighbors_0; map_sizes[0] = 5;
  map[1] = neighbors_1; map_sizes[1] = 3;
  map[2] = neighbors_2; map_sizes[2] = 5;
  map[3] = neighbors_3; map_sizes[3] = 6;
  map[4] = neighbors_4; map_sizes[4] = 6;
  map[5] = neighbors_5; map_sizes[5] = 4;
  map[6] = neighbors_6; map_sizes[6] = 4;
  map[7] = neighbors_7; map_sizes[7] = 3;
  map[8] = neighbors_8; map_sizes[8] = 7;
  map[9] = neighbors_9; map_sizes[9] = 5;
  map[10] = neighbors_10; map_sizes[10] = 4;
  map[11] = neighbors_11; map_sizes[11] = 4;
  map[12] = neighbors_12; map_sizes[12] = 4;
